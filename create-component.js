...
class ${cmpName} extends Component {
    ...
    render() {
        return (
            <section className="${cmpName.toLowerCase()}">
                This Is ${cmpName} Class Component
            </section>
        )
...
const ${cmpName} = (props) => {
    ...
    return (
        <section className="${cmpName.toLowerCase()}">
            This Is ${cmpName} Function Component
        </section>
    )
}
...
const styleTemplate = (styleName) => {
    ...
    return (
 `
 @import "../../scss/setup/functions";
 @import "../../scss/setup/mixins";
 @import "../../scss/setup/typography";
 @import "../../scss/setup/variables";
